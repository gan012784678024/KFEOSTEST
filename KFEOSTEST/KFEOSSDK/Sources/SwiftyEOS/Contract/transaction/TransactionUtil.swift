...
@objcMembers class TransactionUtil: NSObject {
    ...
    static func pushTransaction(transfer: Transfer, code: String, privateKey: PrivateKey, completion: @escaping (_ result: TransactionResult?, _ error: Error?) -> ()) {
        ...
        pushTransaction(abi: abiJson, account: transfer.from, privateKey: privateKey, completion: completion)
    }
